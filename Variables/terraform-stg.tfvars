...
resource_group_name     = "ca-cn-stg-demo-rg" # This can also be stored in GitHub secrets
resource_group_location = "canadacentral"     # This can also be stored in GitHub secrets
environment             = "stg"               # This can also be stored in GitHub secrets

# Variable values for Kubernetes Cluster and Pool
cluster_name        = "ca-cn-stg-aks"
dns_prefix          = "aks-dns"
k8s_version         = "1.22.6"
...
sql_name = "ca-cn-stg-psql01" # This can also be stored in GitHub secrets
